...
export default function LoginPage() {
  ...
  return (
    <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl p-8">
      ...
      <h2 className="text-xl font-semibold text-white mb-6 text-center">Přihlášení</h2>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div>
          ...
          <input
            {...register('password', {
              validate: (v) => v.length > 0 || 'Heslo je povinné',
            })}
            type="password"
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full rounded-lg bg-gradient-to-r from-violet-600 to-purple-700 hover:from-violet-500 hover:to-purple-600 text-white font-semibold py-2.5 text-sm transition shadow-lg shadow-purple-900/50 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {isLoading ? (
            <>
